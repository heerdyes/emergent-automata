...
void setupgrid()
{
  ...
  clist=new ArrayList<>();
  int qw=395, qh=220;
  ca=buildgrid(10, 10, qh, qw, 2, typelist.get(0));
  growgridright(ca, typelist.get(1), qw);
  C ca2=buildgrid(10, 2*qh+10, qh, qw, 2, typelist.get(2));
  growgridright(ca2, typelist.get(3), qw);
  stitchud(ca, ca2);
  wiretorus();
}
